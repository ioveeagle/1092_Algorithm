...
public class TestDataGenerator {
	...
	public int[][] readData() {
		...
		try {
			FileReader fr = new FileReader("D:\\雲端\\程式檔案\\Eclipse\\file\\1092_Algorithm\\src\\hw09\\testData_7694.txt");
			...
			for(int i=0; i<lines; i++) {
				...
				A[i][0] = Integer.parseInt(input.split(" ")[0]);
				A[i][1] = Integer.parseInt(input.split(" ")[1]);
			}
